...
export const strings = {
  zh: {
    ...
    starPromptTitle: '喜欢 PrismOffice 吗？',
    starPromptTitleN: '你已经用 PrismOffice 打开了 {n} 个文档',
    starPromptBody: 'PrismOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 PrismOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
  ...
  en: {
    ...
    starPromptTitle: 'Enjoying PrismOffice?',
    starPromptTitleN: "You've opened {n} documents with PrismOffice",
    starPromptBody:
      'PrismOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like PrismOffice, give us a star on GitHub.',
    setEmail: 'Email',
  ...
  ja: {
    ...
    starPromptTitle: 'PrismOffice はいかがですか？',
    starPromptTitleN: 'PrismOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'PrismOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'PrismOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
  ...
  ko: {
    ...
    starPromptTitle: 'PrismOffice가 마음에 드시나요?',
    starPromptTitleN: 'PrismOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'PrismOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'PrismOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
  ...
  fr: {
    ...
    starPromptTitle: 'PrismOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec PrismOffice',
    starPromptBody:
      'PrismOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si PrismOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
  ...
  de: {
    ...
    starPromptTitle: 'Gefällt Ihnen PrismOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit PrismOffice geöffnet',
    starPromptBody:
      'PrismOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen PrismOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
  ...
  es: {
    ...
    starPromptTitle: '¿Te gusta PrismOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con PrismOffice',
    starPromptBody:
      'PrismOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta PrismOffice, danos una estrella en GitHub.',
  ...
  th: {
    ...
    starPromptTitle: 'ชอบ PrismOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย PrismOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'PrismOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ PrismOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
  ...
  id: {
    ...
    starPromptTitle: 'Suka PrismOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan PrismOffice',
    starPromptBody:
      'PrismOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai PrismOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
  ...
  ru: {
    ...
    starPromptTitle: 'Нравится PrismOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в PrismOffice',
    starPromptBody:
      'PrismOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится PrismOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
  ...
  ar: {
    ...
    starPromptTitle: 'هل أعجبك PrismOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في PrismOffice',
    starPromptBody: 'PrismOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك PrismOffice، ضع لنا نجمة على GitHub.',
  ...
  pt: {
    ...
    starPromptTitle: 'Gostando do PrismOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o PrismOffice',
    starPromptBody:
      'O PrismOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do PrismOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
  ...
  it: {
    ...
    starPromptTitle: 'Ti piace PrismOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con PrismOffice',
    starPromptBody:
      'PrismOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace PrismOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
  ...
  pl: {
    ...
    starPromptTitle: 'Podoba Ci się PrismOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w PrismOffice',
    starPromptBody:
      'PrismOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się PrismOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
  ...
  nl: {
    ...
    starPromptTitle: 'Bevalt PrismOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met PrismOffice',
    starPromptBody:
      'PrismOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als PrismOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
  ...
  ms: {
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan PrismOffice',
    starPromptBody:
      'PrismOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka PrismOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
  ...
  he: {
    ...
    starPromptTitle: 'נהנים מ-PrismOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם PrismOffice',
    starPromptBody: 'PrismOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם PrismOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
  ...
  hi: {
    ...
    starPromptTitle: 'PrismOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने PrismOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'PrismOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको PrismOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
  ...
  'zh-TW': {
    ...
    starPromptTitle: '喜歡 PrismOffice 嗎？',
    starPromptTitleN: '你已經用 PrismOffice 開啟了 {n} 個文件',
    starPromptBody: 'PrismOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 PrismOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
