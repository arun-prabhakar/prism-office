...
import { gskListPastProjects, type GskPastProjectsPage } from '@prismoffice/ai-search'
import {
  cloudStoreOwner,
...
vi.mock('@prismoffice/ai-search', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@prismoffice/ai-search')>()
