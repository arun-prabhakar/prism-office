...
import { showOpenDialogWithMemory } from '@prismoffice/electron-utils'
...
/** office/pdf formats extract text via @prismoffice/file-parse; images skip text extraction and go multimodal (slides:files-read-image) */
...
/** Extract attachment text via @prismoffice/file-parse (docx/pdf/pptx/xlsx/plain text) */
