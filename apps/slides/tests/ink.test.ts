...
import { addPicture, createBlankPptx, openPptx, savePptx } from '@prismoffice/pptx-engine'
import { buildRenderSlide, type PictureRenderNode } from '@prismoffice/pptx-render'
import {
  decodeInkPayload,
  encodeInkPayload,
  inkNodeHitTest,
