...
The serif subset also backs the `PrismOffice Fullwidth TC` face (`fonts.css`), a
...
| Font                              | Role                                             |
| --------------------------------- | ------------------------------------------------ |
| PrismOffice Serif KR (subset woff2) | Batang-metric stand-in for Korean serif families |
| PrismOffice Sans KR (subset woff2)  | fallback for Korean sans families (Malgun etc.)  |
